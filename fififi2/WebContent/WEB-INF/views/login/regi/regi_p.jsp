...
<form action="regiAf.do" id ="regiform"  method="POST" enctype="multipart/form-data"> 
		...
		<tr>
			<td>생년월일</td>
			<td>
				<select name="user_birth1" id="user_birth1" required="required" style="width: 60px;">
				...
				<select name="user_birth2" id="user_birth2" required="required" style="width: 60px;">
				...
				<select name="user_birth3" id="user_birth3" required="required" style="width: 60px;">
		...
		<tr>
			<td>등록일</td>
			<td><input type="text" name="prof_regidate" required="required" pattern="\d{8}">(ex: 20170301)</td>
		</tr>
		<tr >
			<td>직위</td>
